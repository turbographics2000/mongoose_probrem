...
var MongoStore = (function (_EventEmitter) {
  ...
  _createClass(MongoStore, [{
    ...
    value: function _initWithUrl(_ref2) {
      ...
      var _ref2$connectOptions = _ref2.connectOptions;
      var connectOptions = _ref2$connectOptions === undefined ? null : _ref2$connectOptions;

      return new _Promise(function (resolve, reject) {
        _mongodb.MongoClient.connect(url, connectOptions, function (err, client) {
          if (err) {
            reject(err);
            return;
          }
          var options = client && client.s && client.s.options && client.s.options || {};
          var dbName = options.dbName || DEFAULT_DBNAME;
    ...
    value: function _makeConnectionString(user, password, _ref3) {
